...
// these are assigned inside init function
...
const init = function () {
  ...
  currentScore = 0;
  activePlayer = 0;
  // setting state variable to track the playing status
  playing = true;
  ...
  // JS can remove class even if it not there
  player0El.classList.remove('player--winner');
  player1El.classList.remove('player--winner');
  // JS can add class even if it is there
